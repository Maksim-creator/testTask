...
/* harmony import */ var _js_modules_selectAge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../js/modules/selectAge */ "./src/js/modules/selectAge.js");
...
/* harmony import */ var _js_modules_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../js/modules/slider */ "./src/js/modules/slider.js");



Object(_js_modules_selectAge__WEBPACK_IMPORTED_MODULE_0__["default"])('#age');
Object(_js_modules_menu__WEBPACK_IMPORTED_MODULE_1__["default"])('.tab-link');
Object(_js_modules_slider__WEBPACK_IMPORTED_MODULE_2__["default"])('.left-arr', '.right-arr');
...
function menu(menuItemsSelector) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return selectAge; });
function selectAge(triggerSelector) {
  ...
  trigger.addEventListener('click', function (e) {
    ...
    var _trigger$getBoundingC = trigger.getBoundingClientRect(),
        top = _trigger$getBoundingC.top; // let filters = document.querySelector('.selects__wrapper');
    // filters.append(input)


    input.style.marginTop = "".concat(top + pageYOffset + 15, "px");
...
function slider(left, right) {
  ...
  rightArr.addEventListener('click', function () {
    ...
    subtitle.classList.remove('animate__fadeInLeft'); // deleteClasses([img,title,subtitle])
